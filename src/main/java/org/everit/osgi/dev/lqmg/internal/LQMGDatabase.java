...
/**
 * Simple inheritance of H2 database that can be used during LQMG code generation so changelog files can use lqmg
 * specific preconditions and filters.
 */
public class LQMGDatabase extends H2Database {
