...
public class LQMGMetadataExporter {
  ...
  public LQMGMetadataExporter(final ConfigurationContainer configurationContainer,
  ...
  protected EntityType createEntityType(final String schemaName, final String tableName,
  ...
  private void handleColumn(final EntityType classModel, final String tableName,
  ...
  protected void handleTable(final DatabaseMetaData md, final ResultSet tables)
      throws SQLException {
  ...
  private void write(final Serializer serializer, final String path, final EntityType type)
      throws IOException {
